...
docker build --build-arg http_proxy=$proxy_address --build-arg https_proxy=$proxy_address -t prim/scheduler-aarch64-linux -f ../docker/aarch64-linux/dockerfile-scheduler . &&
docker build --build-arg http_proxy=$proxy_address --build-arg https_proxy=$proxy_address -t prim/message-aarch64-linux -f ../docker/aarch64-linux/dockerfile-message . &&
docker build --build-arg http_proxy=$proxy_address --build-arg https_proxy=$proxy_address -t prim/seqnum-aarch64-linux -f ../docker/aarch64-linux/dockerfile-seqnum . &&
docker build --build-arg http_proxy=$proxy_address --build-arg https_proxy=$proxy_address -t prim/api-aarch64-linux -f ../docker/aarch64-linux/dockerfile-api . &&
